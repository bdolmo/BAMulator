...
def main(variants, threads, reference, output, suffix, input_vcf_list, genome_version, map_dir, ref_dir):
    # parser = argparse.ArgumentParser(description='BAMulator: simulate variants in existing BAMs')
    ...
    bamulator_exe = os.path.join(script_dir, "src", "bamulator")
    ...
    try:
        ...
        print(f" INFO: BAMulator completed successfully")
    except subprocess.CalledProcessError as e:
        raise RuntimeError(f" ERROR: Could not execute BAMulator: {str(e)}")
